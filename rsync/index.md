...
rsync推送和拉取
推送:
rsync -avzP -e 'ssh -p 22' /data/data.tar.gz root@192.168.0.2:/data/data.tar.gz  # 将本地data目录下的data.tar.gz推送到远端data目录下data.tar.gz
```

```bash
拉取:

rsync -avzP -e 'ssh -p 22' root@192.168.0.2:/data/data.tar.gz  /data/data.tar.gz # 将远端data目录下的data.tar.gz拉取到本地data目录下data.tar.gz
```
